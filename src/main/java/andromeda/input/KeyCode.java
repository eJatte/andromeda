...
public class KeyCode {
    ...
    public static final int KEYBOARD_KEY_OFFSET = 0;
    public static final int MOUSE_BUTTON_OFFSET = 349;
    public static final int SPECIAL_KEY_OFFSET = 357;

    public static final int MOUSE_BUTTON_1 = (0 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_2 = (1 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_3 = (2 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_4 = (3 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_5 = (4 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_6 = (5 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_7 = (6 + MOUSE_BUTTON_OFFSET);
    public static final int MOUSE_BUTTON_8 = (7 + MOUSE_BUTTON_OFFSET);
    ...
    public static final int KEY_LAST = 357;
